# Agent setup for `mighty-strolling-llama`

This is a deepsec scanning workspace. Project `mighty-strolling-llama` was just registered
(target: `..`). Setup is incomplete — `data/mighty-strolling-llama/INFO.md`
...
2. **Fill in `data/mighty-strolling-llama/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id mighty-strolling-llama
pnpm deepsec process --project-id mighty-strolling-llama
```
